...
void animation()
{
	const char *soundFile = "intro.wav";
...
int main()
{
	...
	do
	{
		...
		case 1:
			...
			fflush(stdin);
			printf("\nIngresa la marca: ");
			getline(cin, new_p.brand);
			printf("\nIngresa el tipo de producto: ");
			getline(cin, new_p.type);
			fflush(stdin);
			do
			{
				printf("\nIngresa la ID del producto: ");
				cin >> id;
			...
			cin >> new_p.price;
			printf("\nIngresa la cantidad de productos a agregar: ");
			cin >> new_p.amount;
		...
		case 4:
			...
			fflush(stdin);
			printf("\nIngresa el tipo de articulo que estas buscando: ");
			getline(cin, type);
			fflush(stdin);
			printf("\n\n la lista de los productos de tipo ");
			cout << type << " es: " << endl;
		...
		case 5:
			...
			fflush(stdin);
			printf("\nIngresa la marca que estas buscando: ");
			getline(cin, brand);
			fflush(stdin);
			printf("\n\n Los siguientes productos que corresponden a la marca ");
			cout << brand << ":" << endl;
		...
		case 10:
			...
			fflush(stdin);
			printf("\nNueva marca: ");
			getline(cin, p->data.brand);
			printf("\nNuevo tipo de producto: ");
			getline(cin, p->data.type);
			fflush(stdin);
			do
			{
				printf("\nIngresa la Nuevo ID del producto: ");
				cin >> id;
				pd = list_of_products.search_id(id);
				if (pd->data.id != -1000)
				{
